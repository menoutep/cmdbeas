...
def validate_pdf_magic(value):
    ...
    # Valider le type MIME du fichier à l'aide de mimetypes
    type_mimetype, encoding = mimetypes.guess_type(value.name)
    
    if type_mimetype != 'application/pdf':
    ...
    if magic_header != b'%PDF':
     ...
     # Utiliser PyPDF2 pour une vérification supplémentaire
